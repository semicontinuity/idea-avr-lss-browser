...
public class AvrLssFindUsagesProvider implements FindUsagesProvider {

    public static final AvrLssFindUsagesProvider INSTANCE = new AvrLssFindUsagesProvider();

    public AvrLssFindUsagesProvider() {
    }

    @Nullable
    public WordsScanner getWordsScanner() {
        return new AvrLssWordsScanner();
    }
